    ...
    <section id="" class="section-diagonal static-section">
        <div class="container grid-lg" style="padding:2rem 30px 1rem;">
            <h1 class="section-header">Privacy Policy</h1>
              ...
              <h2> General information collection and use </h2>
                <p>
              ...
              <h2> Information collection and use for applicants </h2>
                <p>
              ...
              <h2> Transfer and publishing of your data </h2>
                <h3> Sponsors </h3>
                <p>
                ...
                <p> We may share anonymised data with media organisations for the
