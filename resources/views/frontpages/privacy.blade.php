    ...
    <section id="" class="section-diagonal static-section">
        <div class="container grid-lg" style="padding:2rem 30px 1rem;">
            <h1 class="section-header">Privacy Policy</h1>
              ...
              <h2 class="title-text"> Changes to this Privacy Policy </h2>
              <p class="body-text">
                We may update our Privacy Policy from time to time. We will notify you
                of changes by posting the new policy on this page.
              </p>
              <p class="body-text">
                You are advised to review the policy periodically for changes.
                Changes are effective once posted on this page.
              </p>

              <h2 class="title-text"> General information collection and use </h2>
              <p class="body-text">
                While using our service, we may ask you to provide us with certain
                personally identifiable information that can be used to contact or
                identify you. Personally identifiable information may include,
                but is not limited to, your email address, name, phone number,
                address, and other information (‘Personal Information’).
              </p>

              <h2 class="title-text"> Information collection and use for applicants </h2>
              <p class="body-text">
                When you apply to the event, we collect information about you from
                MyMLH that is necessary for running the event, including your MLH ID,
                first name, last name, date of birth, email, phone number, institution,
                study level, course, shirt size, dietary restrictions, and any special
                needs you have entered on your MyMLH profile. During the application
                process, we also collect your CV and your submissions to the questions
                we ask, including information about your interests, and the country
                you are travelling from. We also store your RSVP status and your
                attendee status.
              </p>
              <p class="body-text">
                We use this information for running the hackathon, which involves
                sharing it with trusted third parties. For example, we share
                anonymised data about your dietary requirements with those
                helping us with catering. We also use this information for
              ...
              <p class="body-text">
                ...
                service (known as ‘log data’). This log data may include information
                such as your computer’s IP (Internet Protocol) address, browser type,
              ...
              <p class="body-text">
                ...
                that collect, monitor and analyse this information in order to improve
              ...
              <h3 class="title-text"> Cookies </h3>
              <p class="body-text">
              ...
              <p class="body-text">
                However, we will not share anything else from your application with
                sponsors. Put contact details in your CV if you wish to be able
                to be contacted.
              </p>
              <h3 class="title-text"> Media and publicity </h3>
              <p class="body-text">
                We will take photos throughout the event, and publish them. You may appear
                in some of these photos. We aim to publish photos that show people at their
                best, but if you see a photo of you that you dislike, let us know so that
                we can try to remove it. However, be aware that it is difficult to
                completely erase a photo from all media channels.
              </p>
              <p class="body-text">
                We will publish the names of winners and the winning hacks. We may
                publish other content associated with this, such as videos of the
                winners presenting.
              </p>
              ...
              <p class="body-text">
                ...
                service, provide the service on our behalf, carry out service-related
                activities or to help us in analysing how our service is used.
              </p>
              <p class="body-text">
              ...
              <h3 class="title-text"> International transfer </h3>
              <p class="body-text">
              ...
              <h2 class="title-text"> Provisos </h2>
              <h3 class="title-text"> Legal compliance </h3>
              <p class="body-text">
              ...
              <h3 class="title-text"> Children’s privacy </h3>
              <p class="body-text">
              ...
              <p class="body-text">
                ...
                contact us. If we discover that a child under 13 has provided us with
                Personal Information, we will delete such information from our servers
                immediately.
              </p>
              <h3 class="title-text"> Security </h3>
              <p class="body-text">
                The security of your Personal Information is important to us, but be
                mindful that no method of transmission over the Internet or method
                of electronic storage is completely secure. While we strive to use
