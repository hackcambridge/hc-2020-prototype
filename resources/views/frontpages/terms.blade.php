...
@section('title', 'Terms and Conditions — Hex Cambridge')

@section('content')
<section id="" class="section-terms">
  <div class="container grid-lg" style="padding:2rem 30px 0.25rem;">
    <h1 class="section-header">Terms and Conditions</h1>
    <p class="body-text">
      Hex Cambridge is an event taking place from 23th January
      2021 to the 24th January 2021 <strong>virtually</strong>. It will henceforth
      be referred to as ‘the Event’ or ‘Hex Cambridge’.
    </p>
    <p class="body-text">
      The Organisers of Hex Cambridge, henceforth referred to as
      ‘the Organisers’ in this T&C, refer to any or all of the
      individuals involved with organising the Event in any capacity.
      <!-- <p class="body-text">
                The Premises of Hex Cambridge, henceforth referred to as ‘the
      ...
      <p class="body-text">
        Your registration and RSVP entitles you to admittance to Hex Cambridge.
        Any and all other costs associated with your attendance shall be borne solely by you,
        and Hex Cambridge shall have no liability for such costs.
        <!-- Any travel or
      ...
      <h3 class="title-text">Age Requirements</h4>
        ...
        <p class="body-text">
          By attending Hex Cambridge you acknowledge and agree to grant the Organisers
          the right at Hex Cambridge to record, film, photograph, or capture your likeness
        ...
        <p class="body-text">
          ...
          volunteers at the Event, or staff reserve the right to
        ...
        <a href="{{ route('conduct') }}" target='_blank' )>
          <p class="body-text">Read the Code of Conduct</p>
        </a>

        <hr>

        <!-- <p class="body-text">
          Except as required by law, the Organisers of Hex Cambridge, or the venue
