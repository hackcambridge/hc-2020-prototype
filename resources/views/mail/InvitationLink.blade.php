...
<img src="{{ asset('images/invite_hacker.png') }}" alt="Confirmed Hacker!" />
...
To view your invitation, you can click on the link above, or paste the following link into your browser: https://hackcambridge.com/dashboard/apply/invitation/.
...
<p><strong>If you do not have a team yet</strong>
    We will organise team matching sessions days before the event for you to join others with similar interests. To make this process more efficient, please fill your profile in the dashboard by clicking the avatar at the top right and selecting <code>Profile</code>. The idea description and tags you have enter here will be visible to all other participants and when other participants search for matches in the <code>Team Match</code> window, your discord username may appear if your keywords match their searches. In this way, you can get in touch with other individual participants before the event starts to form a team.
</p>
